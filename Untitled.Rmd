...
```{r}
verbs1 <- ilo_data$Verb_used_1 %>% unique()
verbs2 <- ilo_data$Verb_used_2 %>% unique()
verbs3 <- ilo_data$Verd_used_3 %>% unique() ####AHHHH SPELLING MISTAKE
c(verbs1,verbs2,verbs3) %>% unique
```
