...
#Introduction *(What was used)*
For this analysis I used the *ILOs* for the year 2018/2019 provided by Edith. The *ILOs* of the projects (PRO) were missing from this file, and have therefore not been included in the subsequent analysis. The data contained a total of `r no_courses`courses, which amounted to `r no_ilo_plus_1 -1` *ILOs*.  
```{r clean workspace 1}
